...
import { Link, NavLink } from 'react-router' // dùng react-router-dom thay vì react-router
                ...
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-72">
                            ...
                            <li>
                                <details>
                                    <summary>Dịch vụ điện nước</summary>
                                    <ul>
                            ...
                            <li>
                                <details>
                                    <summary>Dịch vụ điện lạnh</summary>
                                    <ul>
                    ...
                    <Link to="/" className="btn btn-ghost text-xl">Dịch Vụ Nhà Việt</Link>
                </div>
